        ...
        <div className="flex flex-col gap-4 py-4">
          <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
            <div className="w-12 h-12 bg-[#21466D] rounded-lg flex items-center justify-center">
              <img src="/light-logo.png" alt="USAT Logo" className="w-8 h-8 object-contain" />
            </div>
            <div>
              <h4 className="font-medium text-[#21466D]">USAT Kutubxonasi</h4>
              <p className="text-sm text-gray-600">Tez va qulay foydalanish</p>
            </div>
          </div>

          <div className="text-sm text-gray-600 space-y-2">
            <p>✓ Tezkor kirish</p>
            <p>✓ Oflayn ishlash imkoniyati</p>
